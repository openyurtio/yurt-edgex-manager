...
CRD_OPTIONS ?= "crd:preserveUnknownFields=false,generateEmbeddedObjectMeta=true,maxDescLen=0"
...
test: manifests generate fmt vet ## Run tests.
	...
	/bin/bash -c "export ENVTEST_K8S_VERSION=1.24.1;export KUBEBUILDER_CONTROLPLANE_STOP_TIMEOUT=120s;source ${ENVTEST_ASSETS_DIR}/setup-envtest.sh; fetch_envtest_tools $(ENVTEST_ASSETS_DIR); setup_envtest_env $(ENVTEST_ASSETS_DIR); go test ./controllers/... ./pkg/... -coverprofile cover.out"
