...
//+kubebuilder:webhook:path=/mutate-device-openyurt-io-v1alpha1-edgex,mutating=true,failurePolicy=fail,sideEffects=None,groups=device.openyurt.io,resources=edgexes,verbs=create;update,versions=v1alpha1,name=medgex.kb.io.v1alpha1,admissionReviewVersions=v1

var _ webhook.CustomDefaulter = &EdgeXHandler{}

//+kubebuilder:webhook:path=/validate-device-openyurt-io-v1alpha1-edgex,mutating=false,failurePolicy=fail,sideEffects=None,groups=device.openyurt.io,resources=edgexes,verbs=create;update,versions=v1alpha1,name=vedgex.kb.io.v1alpha1,admissionReviewVersions=v1
...
func (webhook *EdgeXHandler) validate(ctx context.Context, edgex *v1alpha1.EdgeX) field.ErrorList {
	...
	listOptions := client.MatchingFields{util.IndexerPathForNodepoolv1: edgex.Spec.PoolName}
